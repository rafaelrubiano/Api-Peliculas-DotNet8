...
namespace ApiPeliculas.Controllers.V1
{
    ...
    public class PeliculasController : ControllerBase
    {
        ...
        public IActionResult ActualizarPatchPelicula(int peliculaId, [FromForm] ActualizarPeliculaDto actualizarPeliculaDto)
        {
            ...
            var categoriaExistente = _pelRepo.GetPelicula(peliculaId);
            if (categoriaExistente == null)
            {
                return NotFound($"No se encontro la película pcon ID {peliculaId}");
            }
        ...
        public IActionResult Buscar(string nombre)
        {
            try
            {
                ...
                if (!peliculas.Any())
                {
                    return NotFound($"No se encontraron películas en la conincidencia con los criterios de búsqueda.");
                }
