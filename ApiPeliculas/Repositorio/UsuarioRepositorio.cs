...
public class UsuarioRepositorio : IUsuarioRepositorio
{
    ...
    public async Task<UsuarioLoginRespuestaDto> Login(UsuarioLoginDto usuarioLoginDto)
    {
        ...
        // Aquí existe el usuario entonces pordemos procesar el Login
    ...
    public async Task<UsuarioDatosDto> Registro(UsuarioRegistroDto usuarioRegistroDto)
    {
        ...
        if (!result.Succeeded)
        {
            // Lanza una excepción o registra los errores en algún lugar
    ...
    // Método para encriptar contrasñas con MD5 se usa tanto en el Acceso como en el Registro
